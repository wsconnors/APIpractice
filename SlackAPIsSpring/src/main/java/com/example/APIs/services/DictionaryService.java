...
//    public Word checkRoot(ResponseEntity<String> response){
//        ObjectMapper mapper = new ObjectMapper();
//        try {
//            JsonNode root = mapper.readTree(response.getBody());
//
...
//    }
//
//    public Word checkResults(JsonNode root){
//        String source;
//        String word;
//        ArrayList<Definition> definitionArrayList;
//
//        try{
//            JsonNode results = root.get("results");
//            word = getWord(results);
//            definitionArrayList = getDefinitions(results);
//        } catch (NullPointerException ne){
//            logger.warn(ne.getMessage());
//        }
//    }
//
//    public String getWord(JsonNode results){
//        try{
//            return results.get()
//        }
//    }
